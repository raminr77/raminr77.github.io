...
const BUTTON_CLASSES = "border w-9 px-2 h-9 flex items-center justify-center hover:border-amber-500 bg-transparent shadow backdrop-blur-sm duration-500 hover:bg-slate-300/5 overflow-hidden";
...
export function PostsSearch() {
  ...
  const handleSearchChange = ({ target }: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
          ...
          >
            ...
            >
              ...
              {posts.map((post: PostMetadata) => {
                ...
                return (
                  <li key={post.id} className="p-4 border-b border-slate-300/40 last:border-0">
                    <Link
                      href={postDetailUrl}
