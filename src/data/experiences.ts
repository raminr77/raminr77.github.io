export const EXPERIENCES_DATA = [
  ...
  {
    id: 4,
    title: 'Motion Graphics & 2D Animations',
    role: 'Editor & Animator',
    date: 'Jan 2016 - Jan 2018',
    achievement: [
      `Editing and creating videos and their sounds with motion graphics animation. working with internet taxis such as Tapsi and other companies like Chappar Persian-Canadian Startup, Isatis Elastic Ceilings, TakNama Digital can Opener Company, Mahak electrical jack building company, the 17 Building Industry Exhibition of Tehran, Alborz State Engineering System, Yazd Standard Organization, Esfahan Police Department, Miad Adineh program of Esfahan Channel (Iranian TV), etc.`
    ],
    skills: [
      'Graphic Design',
      'Video Editing',
