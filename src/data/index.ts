export const MAIN_DATA = {
  ...
  Through this experience, I have honed my skills in front-end development and gained expertise in creating high-quality user interfaces. 
  In addition to front-end development, I am also familiar with back-end technologies like Python and PHP, which has allowed me to contribute to full-stack projects and understand the larger picture of software development. 
  Outside of work, I am an avid tennis player and workout enthusiast. 
  I enjoy learning new things in my field, whether it's exploring new front-end technologies or improving my back-end skills. 
  I also value spending time with my friends and building strong relationships with my colleagues and teammates. 
  Overall, I am a dedicated and fast-learning individual who is passionate about creating high-quality software and collaborating with others. 
